...
public class Board_DAO extends JdbcDAO {
	
//	private static Board_DAO _dao;
//	
//	private Board_DAO() {
...
//	}
//	
//	public static Board_DAO getDAO() {
//		return _dao;
//	}
	
	
	
	public List<FileUploadDTO> fileList () {
		...
		try {
	        ...
	        for(int i=0;i<filelist.length;i++) {//길이 만큼 돌리고
	        	...
	        	int totalSize = (int) filelist[i].length();
	        	FileUploadDTO filelist2=new FileUploadDTO();
	        	filelist2.setStr(str);
	        	filelist2.setFileName(fileName);
	        	filelist2.setTotalSize(totalSize);
	...
	public List<FileUploadDTO> searchFileList (String strNm) {
		
		List<FileUploadDTO> list = new ArrayList<FileUploadDTO>();
		String savePath = "C:/Java/workspace/jspBBS/WebContent/resources/fileFolder"+"/"+strNm;
